...
public class Bootcamp {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((devsIscritos == null) ? 0 : devsIscritos.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (dataFinal == null) {
            ...
            return false;
        if (devsIscritos == null) {
            if (other.devsIscritos != null)
                return false;
        } else if (!devsIscritos.equals(other.devsIscritos))
            return false;
        if (conteudos == null) {
